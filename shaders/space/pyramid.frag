...
void main()
{
    ...
    vec3 diffuse = light.diffuse * diffuse_amount * vec3(texture(material.diffuse, tex_coord));
    ...
    vec3 specular = light.specular * (specular_amount * vec3(texture(material.specular, tex_coord)));
