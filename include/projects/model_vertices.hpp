#ifndef LEARNINGOPENGL_INCLUDE_PROJECTS_MODEL_VERTICES_HPP_
#define LEARNINGOPENGL_INCLUDE_PROJECTS_MODEL_VERTICES_HPP_

#include "system/vertex.hpp"
#include <glad/glad.h>
#include <vector>

std::vector<Vertex> model_cube_vertices =
{
...
std::vector<GLuint> model_cube_indexes =
{
    0, 1, 2,
    2, 3, 0,
    4, 5, 6,
...
std::vector<Vertex> model_lamp_vertices =
{
...
std::vector<GLuint> model_lamp_indexes =
{
    0, 1, 2,
    0, 2, 3,
    0, 4, 7,
